  ...
  return (
    <div className={styles.gridGames}>
      {map(wishlist, (item) => {
        ...
        return (
          <div key={item.id} className={styles.games}>
            <Link href={`/${game.attributes.slug}`}>
              <div>
                <img src={cover.attributes.url} alt={game.attributes.name} />
            ...
            <WishlistIcon gameId={game.id} className={styles.whislistIcon} removeCallback={onReload}/>
          </div>
        )
      })}
    </div>
